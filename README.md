...
## Install
1. Tại thư mục của Project: `composer require vsmov/theme-holy`
2. Kích hoạt giao diện trong Admin Panel

## Update
1. Tại thư mục của Project: `composer update vsmov/theme-holy`
...
### Custom View Blade
- File blade gốc trong Package: `/vendor/vsmov/theme-holy/resources/views/themeholy`
